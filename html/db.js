...
var S_list = {
	...
	"Function_": Sub_Category,
	"Feeling": Feeling,
	"Period": Period,
	"Spacial_Event": Spacial_Event
	}

console.log(Sub_Category.join(' '));
console.log(Function_.join(' '));
console.log(Feeling.join(' '));
console.log(Period.join(' '));
console.log(Spacial_Event.join(' '));
